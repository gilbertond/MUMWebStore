...
<html>
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function (){
                ...
                $(function () {
                    $('#dialog').scroll().resizable({minWidth: 550, maxWidth: 900, minHeight: 400, maxHeight: 480}).draggable({handle: '.drag-handle', scroll: true, containment: "#overlay"});
                });
            });
    ...
    <body>
        ...
        <div align="center" id="dialog" class="web_dialog">
            <div style="opacity: 1;width: 100%;display: none" class="drag-handle">Scheduled Services Registration
            ...
            <div align="center" id="Mainx" style="">                
                <table style="display: none" width="100%">
                    <tr>
                        <td class="web_dialog_title">Scheduled Services Registration</td>
                    ...
                    <form id="createServiceForm">
                                        ...
                                        <td style="background-color: transparent;border-color: #ffffff">
                                            ...
                                            <select class="form-control input-sm" style="width: 220px;" name="service" id="service">
                                                ...
                                                <c:forEach items="${model.services}" varStatus="cnt" var="service">
                                                    <option onclick="$('#autoid').val('${service[0]}');$('#beanname').val('${service[5]}');$('#servicename').prop('readonly', false); $('#description').val('${service[4]}');$('#servicename').val('${service[1]}')" value="${service[1]}">${cnt.count}.&nbsp;${service[1]}</option>
                                                </c:forEach>
                                            </select>
                        ...
                        <div style="width: 30%" align="center" class="modal-footer"><!--btn btn-default btn-sm-->                       
                            ...
                            <button style="float: left" id="submitButton" type="button" class="btn btn-primary" 
                                    onclick="if($('#service').val()==='0'){alert('Select a service first');return true;};
                                callAjaxRequest('saveScheduledService.htm', 'saveDiv', 'POST', $('#createServiceForm').serialize());">SAVE</button>
                            <button type="button" class="btn btn-primary" onclick="HideDialog();">CANCEL</button>
                        </div>
                    </form>
                </div>
            </div>
